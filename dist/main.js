...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM */ \"./src/DOM.js\");\n/* harmony import */ var _logic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logic */ \"./src/logic.js\");\n\n\n\n\n\n(0,_DOM__WEBPACK_IMPORTED_MODULE_1__.gridForPlayers)();\nconst board3 = document.getElementById(\"board-3\");\n(0,_DOM__WEBPACK_IMPORTED_MODULE_1__.defaultGrid)(10, board3, \"column\", 0);\n\n_logic__WEBPACK_IMPORTED_MODULE_2__.player2.placeShip(_logic__WEBPACK_IMPORTED_MODULE_2__.allShipsPlayer2.carrier, \"E\", 2, \"horizontal\", 2);\n_logic__WEBPACK_IMPORTED_MODULE_2__.player2.placeShip(_logic__WEBPACK_IMPORTED_MODULE_2__.allShipsPlayer2.battleShip, \"D\", 5, \"horizontal\", 2);\n_logic__WEBPACK_IMPORTED_MODULE_2__.player2.placeShip(_logic__WEBPACK_IMPORTED_MODULE_2__.allShipsPlayer2.cruiser, \"J\", 5, \"horizontal\", 2);\n_logic__WEBPACK_IMPORTED_MODULE_2__.player2.placeShip(_logic__WEBPACK_IMPORTED_MODULE_2__.allShipsPlayer2.submarine, \"A\", 2, \"horizontal\", 2);\n_logic__WEBPACK_IMPORTED_MODULE_2__.player2.placeShip(_logic__WEBPACK_IMPORTED_MODULE_2__.allShipsPlayer2.destroyer, \"B\", 6, \"horizontal\", 2);\n\nconst allCells = document.querySelectorAll(\".cell\");\nconst direction = \"horizontal\";\nconst q = [\n  _logic__WEBPACK_IMPORTED_MODULE_2__.userShips.carrier,\n  _logic__WEBPACK_IMPORTED_MODULE_2__.userShips.battleShip,\n  _logic__WEBPACK_IMPORTED_MODULE_2__.userShips.cruiser,\n  _logic__WEBPACK_IMPORTED_MODULE_2__.userShips.submarine,\n  _logic__WEBPACK_IMPORTED_MODULE_2__.userShips.destroyer,\n];\n\nconst attackListener = () => {\n  const controller = (0,_logic__WEBPACK_IMPORTED_MODULE_2__.gameController)();\n  controller.disableCells();\n  allCells.forEach((c) => {\n    (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.hideBoard)();\n    const coord = c.getAttribute(\"data-coordinate\");\n    c.addEventListener(\"click\", () => {\n      c.setAttribute(\"data-attacked\", \"true\");\n      (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.attack)(coord);\n      controller.updateRecieveAttack(coord);\n      controller.checkContinueTurn(coord);\n      controller.getActivePlayer().checkAllShipsSunk(\"playerone\");\n    });\n  });\n};\n\nif (q.length !== 0) {\n  allCells.forEach((c) => {\n    const coord = c.getAttribute(\"data-coordinate\");\n    if (coord[3] === \"0\") {\n      c.addEventListener(\"click\", () => {\n        _logic__WEBPACK_IMPORTED_MODULE_2__.player1.placeShip(q[0], coord[0], coord[1], direction, 1);\n        (0,_DOM__WEBPACK_IMPORTED_MODULE_1__.placeUserShip)(coord, q[0]).horizontal();\n        q.shift();\n        if (q.length === 0) attackListener();\n      });\n    }\n  });\n}\n\n\n//# sourceURL=webpack://project-setup-template/./src/index.js?");
