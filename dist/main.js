...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DOM */ \"./src/DOM.js\");\n/* harmony import */ var _logic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./logic */ \"./src/logic.js\");\n\n\n\nconst userShips = (0,_logic__WEBPACK_IMPORTED_MODULE_1__.ships)();\nconst q = [\n  userShips.carrier,\n  userShips.battleShip,\n  userShips.cruiser,\n  userShips.submarine,\n  userShips.destroyer,\n];\n\nconst DOMEvents = () => {\n  const d = document;\n\n  function attackOpponent() {\n    _logic__WEBPACK_IMPORTED_MODULE_1__.controller.disableNonActivePlayerCells();\n    (0,_DOM__WEBPACK_IMPORTED_MODULE_0__.hideBoard)();\n    d.addEventListener(\"click\", (e) => {\n      const coord = e.target.getAttribute(\"data-coordinate\");\n      if (coord[3] === \"2\") {\n        const selectCoord = document.querySelector(\n          `[data-coordinate=${coord}]`,\n        );\n        selectCoord.setAttribute(\"data-attacked\", \"true\");\n        _logic__WEBPACK_IMPORTED_MODULE_1__.controller.updateRecieveAttack(coord);\n        _logic__WEBPACK_IMPORTED_MODULE_1__.controller.checkContinueTurn(coord);\n        _logic__WEBPACK_IMPORTED_MODULE_1__.controller.getActivePlayer().checkAllShipsSunk(\"playerone\");\n      }\n    });\n  }\n\n  if (q.length !== 0) {\n    let direction = \"horizontal\";\n    // eslint-disable-next-line consistent-return\n    d.addEventListener(\"click\", (e) => {\n      if (e.target.matches(\"#rotate\")) {\n        if (direction === \"horizontal\") return (direction = \"vertical\");\n        return (direction = \"horizontal\");\n      }\n    });\n    const allCells = document.querySelectorAll(\".cell\");\n    allCells.forEach((c) => {\n      const coord = c.getAttribute(\"data-coordinate\");\n      if (coord[3] === \"0\") {\n        c.addEventListener(\"mouseover\", () =>\n          (0,_DOM__WEBPACK_IMPORTED_MODULE_0__.hoverColor)(coord, direction, \"aquamarine\", q[0]),\n        );\n        c.addEventListener(\"mouseout\", () => {\n          if (q.length === 0) return;\n          (0,_DOM__WEBPACK_IMPORTED_MODULE_0__.hoverColor)(coord, direction, \"bisque\", q[0]);\n        });\n        c.addEventListener(\"click\", () => {\n          if ((0,_logic__WEBPACK_IMPORTED_MODULE_1__.checkPlaceShip)(coord, direction, q[0]) === \"q\") return;\n          _logic__WEBPACK_IMPORTED_MODULE_1__.controller.disableCellsAroundShip(coord, direction, q[0], 0);\n          q.shift();\n          if (q.length === 0) attackOpponent();\n        });\n      }\n    });\n  }\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DOMEvents);\n\n\n//# sourceURL=webpack://project-setup-template/./src/eventListener.js?");
